...
### Action Required
1. **Restructure `notesData` in `src/data/site-content.js`** to support:
...
**Location to update:**
- `src/data/site-content.js` lines 102-181 (notesData)
- `src/pages/notes/NotesIndex.jsx` - update to show note types differently
- `src/pages/home/Home.jsx` - notes preview section
...
**File:** `src/pages/resume/Resume.jsx`
...
**File:** `src/data/site-content.js` lines 22-100
...
### Notes Section
**File:** `src/data/site-content.js` lines 102-181
