...
**Files Updated:**
- `src/pages/home/Home.jsx` (lines 456-461)
- `src/pages/notes/NotesIndex.jsx` (line 16)
...
**File:** `src/data/site-content.js` (lines 102-118)
...
**Files Updated:**
- `src/pages/home/Home.jsx` (lines 465-486)
- `src/pages/notes/NotesIndex.jsx` (lines 23-43)
...
**Files Updated:**
- `src/app/App.jsx` - Changed route from `notes/:id` to `notes/:slug`
- `src/pages/notes/NoteEntry.jsx` - Updated to handle both slug and numeric ID lookups
...
**File:** `src/pages/notes/NoteEntry.jsx`
...
1. `src/data/site-content.js` - Restructured notesData
2. `src/pages/home/Home.jsx` - Updated section name, UI, navigation
3. `src/pages/notes/NotesIndex.jsx` - Updated archive page
4. `src/pages/notes/NoteEntry.jsx` - Updated entry display logic
5. `src/app/App.jsx` - Updated routing
