...
//
// Outputs:
//   server/essay-previews/generated/gpt7-will-have-arms.js               - HTML body served to crawlers by api/og.js
...
// --- server/essay-previews/generated/gpt7-will-have-arms.js ---
const moduleSource = `// GENERATED FILE - do not edit by hand.
// Regenerate with: node scripts/essays/generate-static.mjs
export const essayArticleHtml = ${JSON.stringify(html)};
`;
writeFileSync(new URL('../../server/essay-previews/generated/gpt7-will-have-arms.js', import.meta.url), moduleSource);
