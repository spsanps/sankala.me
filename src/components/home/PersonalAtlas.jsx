...
export default function PersonalAtlas() {
  ...
  return <section className={`personal-atlas${ordered ? ' is-ordered' : ''}`} id="home" aria-labelledby="cover-title">
    ...
    <div className="atlas-board" ref={board} onPointerMove={move} onPointerLeave={reset}>
      ...
      <a className="atlas-object atlas-award" href="#history-eai-challenge"><img src="/images/awards/uist-2023-presentation.jpg" alt="San and his brother receiving their research award" width="1024" height="768" /><span><small>02 / NeurIPS, 2025</small><strong>First place, with my brother <b>↙</b></strong></span></a>
      <a className="atlas-object atlas-people" href="#history-ucsd-graduation"><img src="/images/history/research-group.webp" alt="With Julian McAuley’s research group at UC San Diego" width="1000" height="468" /><span><small>03 / UC San Diego, 2023</small><strong>The people along the way <b>↙</b></strong></span></a>
    </div>
    <div className="atlas-controls"><span>A few photographs from my life.</span><div><button type="button" onClick={() => { reset(); setOrdered(!ordered); }} aria-pressed={ordered}>{ordered ? 'Spread the collection ↗' : 'Arrange as a grid ⊞'}</button></div></div>
