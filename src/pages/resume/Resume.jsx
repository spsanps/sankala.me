...
export default function Resume() {
  return <main id="main" className="shell">
    ...
    <header className="page-heading"><span className="eyebrow">San Kala / Curriculum vitae</span><h1>CV</h1><p>Information extraction · Language models · Multimodal AI · ASIC design</p><div className="actions"><Action href="/documents/resume.pdf">Download CV</Action><Action href="mailto:san@sankala.me" quiet>Email me</Action></div></header>
