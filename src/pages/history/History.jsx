...
export default function History() {
  return <main id="main" className="shell"><Metadata title="History — San Kala" description="From NIT Karnataka and Texas Instruments to UC San Diego and AI research at eBay. The projects, research, competitions, and detours along the way." path="/history" />
    <header className="page-heading history-heading"><div><span className="eyebrow">San Kala / History</span><h1>Career & history</h1><p>From electrical engineering and chip design to AI research—with a startup, some competitions, and a few detours along the way.</p></div><figure><img src="/images/history/research-group.webp" alt="San with the UC San Diego research group." width="640" height="426" /><figcaption>UC San Diego / the research years</figcaption></figure></header>
    ...
    <section className="history-end"><span className="eyebrow">More</span><h2>Writing, projects and research</h2><div className="actions"><Action href="/notes">Browse all work</Action><Action href="/resume" quiet>Full CV</Action></div></section>
  </main>;
}
