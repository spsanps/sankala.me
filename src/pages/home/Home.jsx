...
export default function Home() {
  return <main id="main" className="atlas-home">
    ...
    <section className="home-latest shell" id="latest" aria-labelledby="latest-title"><div className="folio-heading"><span>01 / Recently made</span><h2 id="latest-title">Recent work.</h2><Link to="/notes">All work & search ↗</Link></div>
    ...
    <section className="home-history shell" id="history" aria-labelledby="history-title"><div className="folio-heading"><span>02 / The story so far</span><h2 id="history-title">My path<br /><em>so far.</em></h2><Link to="/resume">Full CV ↗</Link></div><p className="section-introduction">From an electronics lab in Karnataka to chip design, graduate school, and AI research. The people, projects and photographs along the way.</p><PhotoTimeline /></section>
    <section className="home-writing shell" id="writing" aria-labelledby="writing-title"><div className="folio-heading"><span>03 / Essays & notes</span><h2 id="writing-title">Writing<br /><em>& ideas.</em></h2><Link to="/writing">All writing ↗</Link></div><WritingList headingLevel={3} /></section>
    <section className="home-projects shell" id="projects" aria-labelledby="projects-title"><div className="folio-heading"><span>04 / Open in your browser</span><h2 id="projects-title">Projects to<br /><em>play with.</em></h2><Link to="/research">Research papers ↗</Link></div><ProjectList /></section>
