...
<p>This year's favorite dismissal of AI agents is that they are "just an LLM in a while loop." It's meant as a deflation, but it points at something real: a loop is a search process, and a search process is only as good as the signal it climbs. At NeurIPS 2025, my brother Chin and I won the <a href="https://neurips25-eai.github.io/">Embodied Agent Interface challenge</a> by giving that loop the strongest signal available: <strong>the benchmark's own evaluator</strong>.</p>
...
<p>Our result also hints at where the bottleneck in embodied AI lives. Once the data existed, 0.6-billion-parameter models were enough to saturate the benchmark; the missing ingredient was data, not capacity. If frontier models are going to become the robot brains, as I argue in <a href="https://www.sankala.me/essays/gpt7-will-have-arms">GPT-7 Will Have Arms</a>, loops like this one are among the cheapest ways to manufacture the embodied training data they will need. Whether what the loop learns survives the jump from simulation to hardware is the natural next experiment.</p>
<hr>
<p>Team AxisTilted2: Chin Pradeep (NYU Neuroinformatics Lab) and San Kala (independent); equal contribution. Full methods are in the <a href="https://openreview.net/pdf?id=gABfrJI5ni">technical report</a> and <a href="https://foundation-models-meet-embodied-agents.github.io/eai_challenge/slides/AxisTilted2.pdf">winners' presentation</a>. The benchmark: <a href="https://neurips25-eai.github.io/">Embodied Agent Interface</a>.</p>
`;
